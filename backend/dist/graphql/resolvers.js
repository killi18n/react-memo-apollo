        ...
        memos: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Memo_1.default.find()];
                    case 1:
                        memos = _a.sent();
                        return [2 /*return*/, memos];
                    case 2:
                        e_1 = _a.sent();
                        console.log(e_1);
                        return [3 /*break*/, 3];
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, Memo_1.default.findById(_id)];
                        case 1:
                            memo = _b.sent();
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 2, , 3]);
                            memo = new Memo_1.default({
                                content: content,
                                writer: writer,
                                createdAt: createdAt,
                            });
                            return [4 /*yield*/, memo.save()];
                        case 1:
                            _b.sent();
                            return [2 /*return*/, memo];
                        case 2:
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, Memo_1.default.findByIdAndUpdate(_id, {
                                    content: content,
                                }, {
                                    new: true,
                                })];
